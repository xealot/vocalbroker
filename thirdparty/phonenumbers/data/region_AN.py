...
PHONE_METADATA_AN = PhoneMetadata(id='AN', country_code=599, international_prefix='00',
    ...
    fixed_line=PhoneNumberDesc(national_number_pattern='5(?:4\\d|8[239])\\d{4}', possible_number_pattern='\\d{7}', example_number='5451234'),
    mobile=PhoneNumberDesc(national_number_pattern='5(?:1[01]|2[0-7]|5\\d|8[016-8])\\d{4}', possible_number_pattern='\\d{7}', example_number='5101234'),
